...
## load data
dat <- read_excel("chat_analyze.xlsx")
...
ui <- navbarPage(title =  div(img(src = "logo.jpg", id = "yource", height = "40px",width = "100px",style = "position: relative; margin:-10px 5px; display:right-align;", "By Patrick Zoet")), 
                 ...
                 tabPanel("Main Analysis",
                          ...
                          sidebarLayout(
                            sidebarPanel(
                              selectizeInput("Employee", label="Employee Name:", choices = list("ALL" = "all", "Boris Mendani" = "BM", "Patrick Zoet" = "PZ", "Marco Tuinzand" = "MT", "Donna Marotti" = "DM", "Esmee Hoefwegen" ="EH",  "Christel Palasuka" ="CP" , "Diego Manhoef" = "DM",  "Sara Denning" ="SD", "Remco Boers" ="RB", "Sam Wegers"="SW" , "Ian v Ingen" ="II",  "Kyuri Kloppers" ="KK",  "Karel Hendriks"= "KH", "Johanna Dieders" ="JD", "Michael Knoppert" = "MK", "Hendrik Hendriksen" ="HH", "Matthijs Snoek" ="MS",  "Conny Blijhoef"= "CB",  "Ronald Terrings" = "RT", "Daniel Leenders" ="DL",  "Youri Wegemans" ="YW", "Truus Bonten" = "TB", "Ian v/d Malen" = "IM", "Lara Brutens" ="LB"),options = list(maxItems = 5, placeholder = 'Select a name'), selected = "all"),
                              ...
                              helpText(HTML('&copy;2022 Patrick Zoet')),
                            ),
